...
Output: 
The given dataset is 2-dimensional data having 1000 rows and 9 attributes where there are no missing values in the data. The notebook contains EDA and data with graphical representation and predictions with Logistic regression and Random forest classifier.
